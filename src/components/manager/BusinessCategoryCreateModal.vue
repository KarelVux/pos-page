...
const managerBusinessCategoryService = new BusinessCategoriesService();
...
const onSubmit = async (event: MouseEvent) => {
    ...
    if (displayData.value) {
        businessCategory = await managerBusinessCategoryService.create(identity, displayData.value!)
    }
    if (businessCategory) {
